...
Group Library for Black Projects.
...
The recommended way to install Group is through [Composer][2]:
...
__Protip:__ You should browse the [`black/group`][7] group to choose a stable version to use, avoid the `@stable` meta
constraint.
...
Group is released under the MIT License. See the bundled LICENSE file for details.
...
[7]: https://packagist.org/packages/black/group
